...
This is a production-ready REST API for a **device QuickyCell**. Users submit devices for sale, choose configuration options, get a dynamic price quote, and place orders. Admins manage the full lifecycle: confirm, receive, inspect, and pay out.
